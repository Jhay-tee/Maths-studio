  ...
  return (
    <div className="min-h-screen bg-[#0b0b0b] text-white flex flex-col font-sans selection:bg-white/20">
      ...
      <main className="flex-1 overflow-hidden flex flex-col relative">
        <div ref={scrollRef} className="flex-1 overflow-y-auto min-h-0 p-4 md:p-8 space-y-8 scroll-smooth pb-[15rem] md:pb-[13rem]">
          {messages.length === 0 ? (
            <motion.div 
        ...
        <div className="fixed bottom-0 left-0 right-0 z-40 border-t border-white/5 bg-[#0b0b0b]/92 backdrop-blur-xl safe-bottom">
